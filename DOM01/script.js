const moviesDiv=document.getElementById("movislist");
const movies =[
    {
      "Title": "Avatar",
      "Year": "2009",
...
movies.forEach( function (m)
{
  ...
  mDiv.classList.add('myMovie')
  const moviesImage=document.createElement('img')
  moviesImage.src=m.Images;
  ...
  mDiv.append(Image,Title,Year)
  moviesDiv.appendChild(mDiv)
